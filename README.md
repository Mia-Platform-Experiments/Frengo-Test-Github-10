# Frengo - Test GitHub 10 Configurations

This repository contains all the configuration resources required for the Frengo - Test GitHub 10 project to function properly and expose its business features.
